# 🏴‍☠️ 안녕하세요! 세상을 소프트웨어로 연결하고 싶은 개발자입니다.

현재 컴퓨터공학을 전공하며 졸업을 앞두고 있는 예비 개발자입니다.  
...
<p>
  ...
  <img src="https://img.shields.io/badge/.NET%20MAUI-E11E49?style=for-the-badge&logoColor=white" />
</p>

**Graphics & Database & Infrastructure**
<p>
  <img src="https://img.shields.io/badge/SkiaSharp-FF9900?style=for-the-badge&logo=skia&logoColor=white" />
...
* **Game Server Architecture**: 대규모 접속을 처리하기 위한 서버 모델과 네트워크 프로토콜 최적화에 관심이 많습니다.
* **Full-Stack Optimization**: PostgreSQL과 .NET을 결합한 효율적인 데이터 관리 및 쿼리 최적화 연구 중입니다.
